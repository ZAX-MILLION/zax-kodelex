...
import { getSeriesAppearanceOverride } from '@/features/appearance/appearanceMode';

export function DemoAdminAppearancePage() {
    ...
    <div className="mx-auto w-full max-w-[1400px] space-y-8">
      <div>
        ...
        <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
          Same Light / Dark / System controls as production{' '}
      ...
      <section className="space-y-4">
        <h2 className="text-lg font-semibold text-foreground">Global appearance</h2>
        <Card>
          <CardContent className="pt-6">
            <SeriesAppearanceControls onChanged={() => setTick((n) => n + 1)} />
          </CardContent>
        </Card>
      </section>

      <section className="space-y-4">
        <h2 className="text-lg font-semibold text-foreground">Live component preview</h2>
