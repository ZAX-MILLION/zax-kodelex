...
-- Get the new manga IDs for additional chapters
...
SELECT 
  'The First Test', 1, 
  ARRAY['/src/assets/manga-pages/mystic-academy-ch1-p1.jpg'], 1,
...
SELECT 
  'The Dragon Egg', 1,
  ARRAY['/src/assets/manga-pages/dragons-legacy-ch1-p1.jpg'], 1,
